...
pub const DEC_QUAD_ONE: DecQuad = {
  #[cfg(target_endian = "little")]
  {
    DecQuad {
      bytes: [
        0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x22,
      ],
    }
  }
  #[cfg(target_endian = "big")]
  {
    DecQuad {
      bytes: [
        0x22, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
      ],
    }
  }
};
...
pub const DEC_QUAD_TWO: DecQuad = {
  #[cfg(target_endian = "little")]
  {
    DecQuad {
      bytes: [
        0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x22,
      ],
    }
  }
  #[cfg(target_endian = "big")]
  {
    DecQuad {
      bytes: [
        0x22, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
      ],
    }
  }
};
...
pub const DEC_QUAD_TEN: DecQuad = {
  #[cfg(target_endian = "little")]
  {
    DecQuad {
      bytes: [
        0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x22,
      ],
    }
  }
  #[cfg(target_endian = "big")]
  {
    DecQuad {
      bytes: [
        0x22, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10,
      ],
    }
  }
};
...
pub const DEC_QUAD_HUNDRED: DecQuad = {
  #[cfg(target_endian = "little")]
  {
    DecQuad {
      bytes: [
        0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x22,
      ],
    }
  }
  #[cfg(target_endian = "big")]
  {
    DecQuad {
      bytes: [
        0x22, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80,
      ],
    }
  }
};
...
pub const DEC_QUAD_THOUSAND: DecQuad = {
  #[cfg(target_endian = "little")]
  {
    DecQuad {
      bytes: [
        0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x22,
      ],
    }
  }
  #[cfg(target_endian = "big")]
  {
    DecQuad {
      bytes: [
        0x22, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x04, 0x00,
      ],
    }
  }
};
...
pub const DEC_QUAD_MILLION: DecQuad = {
  #[cfg(target_endian = "little")]
  {
    DecQuad {
      bytes: [
        0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x22,
      ],
    }
  }
  #[cfg(target_endian = "big")]
  {
    DecQuad {
      bytes: [
        0x22, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00,
      ],
    }
  }
};
...
pub const DEC_QUAD_BILLION: DecQuad = {
  #[cfg(target_endian = "little")]
  {
    DecQuad {
      bytes: [
        0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x22,
      ],
    }
  }
  #[cfg(target_endian = "big")]
  {
    DecQuad {
      bytes: [
        0x22, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00,
      ],
    }
  }
};
